                ...
                <div class="gallery-main-box">
                    ...
                    <div class="content-flex">
                        ...
                        <div class="gallery-dot-overflow">
                            <div class="gallery-dots" id="gallery-dots-id" data-scene-id="{{ $scene->id }}">
                            ...
                            <div class="dropdown dropdown-{{ $scene->id }}">
                                <a href="{{ route('scene.artboard', $scene->id) }}" id="{{ $scene->id }}">Edit</a>
                                <a href="javascript:void(0)" class="delete-link" data-id="{{ $scene->id }}"
                                    onclick="showDeleteConfirmation({{ $scene->id }})" class="delete-link"
                                    id="sketch">Delete</a>
                                <a href="javascript:void(0)" class="scene-invitation" data-id="{{ $scene->id }}"
                                    id="figma">Invite</a>

    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.packages.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('yearly_discount') ? 'is-invalid' : '' }}" type="number" name="yearly_discount" id="yearly_discount" value="{{ old('yearly_discount', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('scene_limit') ? 'is-invalid' : '' }}" type="number" name="scene_limit" id="scene_limit" value="{{ old('scene_limit', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('item_limit') ? 'is-invalid' : '' }}" type="text" name="item_limit" id="item_limit" value="{{ old('item_limit', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('google_ads_free') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="google_ads_free" id="google_ads_free" value="1" {{ old('google_ads_free', 0) == 1 || old('google_ads_free') === null ? 'checked' : '' }}>
